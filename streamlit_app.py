...
uploaded_file = st.file_uploader("Upload a picture of the ingredients you have")
...
if prompt := st.chat_input():
    ...
    response = client.chat.completions.create(model="gpt-3.5", messages=st.session_state.messages)
